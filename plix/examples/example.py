...
s1 = Slide().text('Plix: Storytelling with Interactive Data',y=0.75,color='#FFDAB9',fontsize=0.08,animation=[1,1]).\
               text('Giuseppe Romano',y=0.6,fontsize=0.04,animation=[0,1]).\
               text('(Presentation made with Plix)',y=0.3,fontsize=0.04,animation=[0,1])
...
s3 = Slide().text('The solution: Plix',y=0.85,color='#FFDAB9',fontsize=0.08).\
             ...
             shape('arrow',x=0.34,y=0.29,w=0.1,orientation=0).\
             plotly(fig,w=0.53,x=0.45,y=0.25,h=0.5)
...
#Presentation([s1],title='test15').share()
#Presentation([s1,s2,s3,s4,s5,s6,s7,s8],title='pitch').share()
#quit()
#Presentation([s1,s2,s3,s4,s5,s6,s7,s8],title='pitch').share()

Presentation([s1],title='exmaple').show()
...
#Presentation([s3,s4],title='test15').share()
#Presentation([s2],title='image').show()
